/**
 * Airbnb-style footer component
 */
import React from 'react';

/**
 * Footer component with Airbnb-inspired design
 * @returns React component
 */
const AirbnbFooter: React.FC = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-500 text-center">
            &copy; 2025 CityCompare, Inc. All rights reserved.
          </p>
          <div className="mt-4 flex justify-center space-x-6">
            <span className="inline-flex items-center text-sm text-gray-500">
              <svg className="h-5 w-5 text-rose-500 mr-1" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
