...
/**
 * Component for displaying a compact section of city cards with pagination
 * @param props - Component props
 * @returns React component
 */
const CompactCityCardsSection: React.FC<CompactCityCardsSectionProps> = ({ title, data, type, getProgressWidth }) => {
  ...
  const handlePageChange = (pageNumber: number) => {
    ...
    window.scrollTo({
      top: document.getElementById('city-cards-section')?.offsetTop || 0,
      behavior: 'smooth'
    });
  };
  
  return (
    <section id="city-cards-section" className="mb-6">
...
export default CompactCityCardsSection;
